...
import { stopAgoraSttTranslation } from "@/lib/live-assistance/agora-stt-translation";
...
export async function DELETE(request: Request, context: RouteContext) {
  ...
  try { await stopAgoraSttTranslation(session.agentId); removeLiveAssistanceSession(sessionId); return NextResponse.json({ success: true }); }
